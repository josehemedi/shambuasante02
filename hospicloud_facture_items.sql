...
CREATE TABLE `facture_items` (
  ...
  `id_produit_pharmacie` int DEFAULT NULL,
  `id_acte_medical` int DEFAULT NULL,
  PRIMARY KEY (`id_item`),
  KEY `idx_item_facture` (`id_facture`),
  CONSTRAINT `fk_item_facture` FOREIGN KEY (`id_facture`) REFERENCES `factures` (`id_facture`) ON DELETE CASCADE

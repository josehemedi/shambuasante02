...
CREATE TABLE `consultations` (
  ...
  CONSTRAINT `consultations_ibfk_1` FOREIGN KEY (`id_rdv`) REFERENCES `rendez_vous` (`id_rdv`) ON DELETE SET NULL,
  CONSTRAINT `consultations_ibfk_3` FOREIGN KEY (`id_medecin`) REFERENCES `utilisateurs` (`id_utilisateur`) ON DELETE CASCADE

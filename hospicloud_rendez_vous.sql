...
CREATE TABLE `rendez_vous` (
  ...
  `type_consultation` enum('PHYSIQUE','VIDEO') DEFAULT 'PHYSIQUE',
  ...
  CONSTRAINT `rendez_vous_ibfk_2` FOREIGN KEY (`id_medecin`) REFERENCES `utilisateurs` (`id_utilisateur`) ON DELETE CASCADE

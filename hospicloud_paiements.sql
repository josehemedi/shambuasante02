...
CREATE TABLE `paiements` (
  ...
  CONSTRAINT `paiements_ibfk_1` FOREIGN KEY (`id_facture`) REFERENCES `factures` (`id_facture`) ON DELETE CASCADE,
  CONSTRAINT `paiements_ibfk_2` FOREIGN KEY (`id_mode_paiement`) REFERENCES `modes_paiement` (`id_mode_paiement`) ON DELETE CASCADE

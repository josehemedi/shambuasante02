...
CREATE TABLE `medicaments` (
  ...
  `nom_generique` varchar(150) DEFAULT NULL,
  ...
  CONSTRAINT `medicaments_ibfk_1` FOREIGN KEY (`id_categorie`) REFERENCES `categories_medicaments` (`id_categorie`) ON DELETE CASCADE
...
INSERT INTO `medicaments` VALUES (1,1,'Paracétamol 500','Paracétamol','Comprimé','500mg',0.50,NULL);

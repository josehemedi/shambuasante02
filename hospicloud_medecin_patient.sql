...
CREATE TABLE `medecin_patient` (
  ...
  CONSTRAINT `medecin_patient_ibfk_1` FOREIGN KEY (`id_patient`) REFERENCES `patients` (`id_patient`) ON DELETE CASCADE
...
LOCK TABLES `medecin_patient` WRITE;
/*!40000 ALTER TABLE `medecin_patient` DISABLE KEYS */;
INSERT INTO `medecin_patient` VALUES (1,5,'2026-06-09 04:00:18');

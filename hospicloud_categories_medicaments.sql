...
CREATE TABLE `categories_medicaments` (
  ...
  CONSTRAINT `categories_medicaments_ibfk_1` FOREIGN KEY (`id_hopital`) REFERENCES `hopitaux` (`id_hopital`) ON DELETE CASCADE
...
INSERT INTO `categories_medicaments` VALUES (1,1,'Analgésiques',NULL);

...
CREATE TABLE `ordonnances` (
  ...
  `statut` enum('ACTIVE','SERVIE','ANNULEE') DEFAULT 'ACTIVE',
  PRIMARY KEY (`id_ordonnance`),
  KEY `idx_ord_hopital_date` (`id_hopital`,`date_prescription`),
  KEY `idx_ord_patient_lookup` (`id_patient`),
  CONSTRAINT `fk_ord_hopital` FOREIGN KEY (`id_hopital`) REFERENCES `hopitaux` (`id_hopital`),
  CONSTRAINT `fk_ord_patient` FOREIGN KEY (`id_patient`) REFERENCES `patients` (`id_patient`)

...
--
-- Table structure for table `rendez_vous01`
--

DROP TABLE IF EXISTS `rendez_vous01`;
...
--
-- Dumping data for table `rendez_vous01`
--

LOCK TABLES `rendez_vous01` WRITE;
/*!40000 ALTER TABLE `rendez_vous01` DISABLE KEYS */;
/*!40000 ALTER TABLE `rendez_vous01` ENABLE KEYS */;
UNLOCK TABLES;
